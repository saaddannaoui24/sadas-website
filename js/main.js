...
(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      'svc4-p1': 'SADAS is an authorised Whish Money agent, offering a full range of electronic payment and transfer services directly from our Tripoli office. Whish Money is one of Lebanon\'s leading licensed payment networks, trusted by hundreds of thousands of users nationwide.',
      'svc4-p2': 'Our Whish services cover domestic and international money transfers, mechanic fee payments, all taxes and Ministry of Finance charges, phone bills (Alfa, Touch, Ogero), wedding list gift collection, Beirut and regional municipality fees, real estate services, employee payroll processing, and the sale of prepaid lines, internet cards, and gift cards.',
      'svc4-tag1': 'Domestic Transfers', 'svc4-tag2': 'International Transfers',
      'svc4-tag3': 'Mechanic Fee Payments', 'svc4-tag4': 'Taxes & Gov. Fees',
      'svc4-tag5': 'Phone Bills (Alfa / Touch / Ogero)', 'svc4-tag6': 'Wedding Lists',
      'svc4-tag7': 'Municipality Fees', 'svc4-tag8': 'Real Estate Services',
      'svc4-tag9': 'Employee Payroll', 'svc4-tag10': 'Prepaid & Gift Cards',
      ...
      'contact-address-val': 'Dam &amp; Farez, Street 32<br>After Salam Roundabout, Dayin Building<br>Tripoli, Lebanon',
    ...
    ar: {
      ...
      'svc4-p1': 'سادس وكيل معتمد لويش موني، تقدم مجموعة كاملة من خدمات الدفع الإلكتروني والتحويل المالي مباشرة من مكتبنا في طرابلس. ويش موني إحدى شبكات الدفع المرخصة الرائدة في لبنان، يثق بها مئات الآلاف من المستخدمين على مستوى البلاد.',
      'svc4-p2': 'تشمل خدمات ويش لدينا: التحويلات المحلية والدولية، تسديد رسوم الميكانيك، جميع الضرائب ورسوم وزارة المالية، فواتير الهاتف (ألفا وتاتش وأوجيرو)، تحصيل هدايا لائحة الأعراس، رسوم بلدية بيروت وغيرها، الخدمات العقارية، توطين رواتب الموظفين، وبيع بطاقات الخطوط المسبقة الدفع وبطاقات الإنترنت وبطاقات الهدايا.',
      'svc4-tag1': 'التحويلات المحلية',
      'svc4-tag2': 'التحويلات الدولية',
      'svc4-tag3': 'تسديد رسوم الميكانيك',
      'svc4-tag4': 'الضرائب والرسوم الحكومية',
      'svc4-tag5': 'فواتير الهاتف (ألفا / تاتش / أوجيرو)',
      'svc4-tag6': 'هدايا لائحة الأعراس',
      'svc4-tag7': 'رسوم البلدية',
      'svc4-tag8': 'الخدمات العقارية',
      'svc4-tag9': 'توطين الرواتب',
      'svc4-tag10': 'بطاقات مسبقة الدفع وهدايا',
      ...
      'contact-address-val': 'دام وفارز، شارع 32<br>بعد دوار السلام، بناية دايين<br>طرابلس، لبنان',
